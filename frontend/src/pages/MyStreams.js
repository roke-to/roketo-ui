...
import { fromNear, fromTaras, NEAR, loader, TARAS } from '../components/Helpers'
      ...
      >
        <div className='card-body'>
          <div className='d-flex flex-row justify-content-between w-100'>
            ...
            <small className='col-1 m-1'>
              {output.token_name === 'NEAR'
                ? fromNear(output.available_to_withdraw).toFixed(2)
                : fromTaras(output.available_to_withdraw).toFixed(2)}
            </small>
            <small className='col-1 m-1'>
              {output.token_name === 'NEAR'
