      ...
      <Layout className={styles.layout}>
        <section className={styles.section}>
          ...
          <div className={styles.links}>
            <a
              href='https://roke-to.github.io/roke.to/#page-top'
              target='_blank' rel='noreferrer'
            >
              About
            </a>
            <a
              href='https://roke-to.github.io/roke.to/#how-work'
              target='_blank' rel='noreferrer'
            >
              Features
            </a>
            <a
              href='https://roke-to.github.io/roke.to/#used-technologies'
              target='_blank' rel='noreferrer'
            >
              Docs
            </a>
            <a
              href='https://roke-to.github.io/roke.to/#team'
              target='_blank' rel='noreferrer'
            >
              Team
            </a>
            <a
              href='https://roke-to.github.io/roke.to/#blog'
              target='_blank' rel='noreferrer'
            >
              Blog
            </a>
